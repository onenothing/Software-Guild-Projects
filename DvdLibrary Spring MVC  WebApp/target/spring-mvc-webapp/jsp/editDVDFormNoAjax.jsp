...
<html>
    ...
    <body>
        ...
        <div class="container">
            <h1>Edit DVD Form</h1>
            <a href="displayDVDListNoAjax">DVD Library No Ajax</a>
            <hr/>
            <sf:form class="form-horizontal" modelAttribute="dvd"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <sf:input type="text" class="form-control" id="add-first-title" path="dvdTitle" placeholder="DVD Title"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                        <sf:input type="text" class="form-control" id="add-mpaaRating" path="mpaaRating" placeholder="MPAA"/>
                ...
                <div class ="form-group">
                    <div class ="col-md-offset-4 col-md-8">
                        <button type="submit" id="edit-button" class="btn btn-default">Edit New DVD</button>
                    </div>
                </div>
            </div>
        </sf:form>
